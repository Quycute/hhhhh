...
bot_token = '6748031892:AAFYLvQPnPcL3cOfh-BCzMcfDQF25Bzz1QE' 
...
def startkey(message):
    ...
    key = "QUY-" + str(int(message.from_user.id) * int(datetime.date.today().day) - 12666)
    key = "https://key.c25tool.net/key.html?key=" + key
    print(key)
    api_token = 'a3549cab5c737619f7576e2d4d9d8fe36b2f28b70831fd1e119f185dc8b6d587'    
    url = requests.get(f'https://yeumoney.com/QL_api.php?token={api_token}&url={key}').json()
